	...
	<head>
        ...
        <script language="javascript">
            ...
            function bookSelect()
	        {
                 ...
                 document.getElementById("bookId").value=ret[0];
				     ...
				     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
					    ...
					    <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="userJiehao" size="50"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    <td width="10%" bgcolor="#FFFFFF" align="right">
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        ...
						        <input type="hidden" name="bookId" id="bookId" size="60"/>
						        <input type="button" value="选择" onclick="bookSelect()"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    <td width="10%" bgcolor="#FFFFFF" align="right">
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input name="jieyueShijian" readonly="readonly" class="Wdate" size="50"  
						        type="text" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(new Date())%>"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    <td width="10%" bgcolor="#FFFFFF" align="right">
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input name="yinghuanShijian" readonly="readonly" class="Wdate" size="50"  
						        type="text" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(new Date(new Date().getTime()+10*24*60*60*1000)) %>"/>
						    </td>
						</tr>
